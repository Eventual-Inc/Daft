...
Note: Jump to the bottom of this document to see how [`TranscriptionResult`](#appendix-transcriptionresult-definition) is defined.
...
- **GitHub**: [github.com/Eventual-Inc/Daft](https://github.com/Eventual-Inc/Daft) to keep up with the latest updates and contribute to the project.
