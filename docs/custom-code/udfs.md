...
See the `TextEmbedder` UDF in our [document processing example](../examples/document-processing.md) for a complete example of using a class UDF with concurrency.
