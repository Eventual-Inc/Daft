...
| Method              | Description                                                        |
| ------------------- | ------------------------------------------------------------------ |
| `attach`            | Attaches a catalog or table to this session.                       |
| `attach_catalog`    | Attaches (or creates) a catalog to this session                    |
| `attach_table`      | Attaches (or creates) a table to this session                      |
