...
| [`create_namespace_if_not_exists`](api_docs/session.html#daft.Session.create_namespace_if_not_exists) | Creates a new namespace if it doesn't already exist                |
| [`create_table`](api_docs/session.html#daft.Session.create_table)                                     | Creates a new table from the source                                |
| [`create_table_if_not_exists`](api_docs/session.html#daft.Session.create_table_if_not_exists)         | Creates a new table from the source if it doesn't already exist    |
