...
Daft Dataframe focuses on Machine Learning/Deep Learning workloads that often involve Complex and complex data (images, video, audio, text documents and more).
