...
NOTE: This is a vendored copy of `daft/datasets/lerobot.py` from the Daft repo,
included here so this example runs against released `daft` wheels. Once the
module ships in a Daft release, delete this file and switch the imports in this
directory to `from daft.datasets import lerobot`.
