...
class TestLanceCaching:
    ...
    def test_cache_initialization(self):
        ...
        try:
            ...
            from daft.daft import init_lance_cache, get_lance_cache_stats, clear_lance_cache
    ...
    def test_lance_kv_store_with_caching(self, lance_dataset_path):
        ...
        try:
            ...
            df = daft.from_pydict({"row_id": [1, 2, 3, 4, 5]})
    ...
    def test_cache_performance_improvement(self):
        ...
        try:
            from daft.daft import init_lance_cache, get_lance_cache_stats
