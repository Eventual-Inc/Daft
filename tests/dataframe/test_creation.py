...
def test_load_pydict_types():
    ...
    expected = {
        ...
        "arrow_struct": ExpressionType._infer_from_py_type(dict),
        "arrow_nulls": ExpressionType.null(),
        "py_objs": ExpressionType._infer_from_py_type(MyObj),
        "heterogenous_py_objs": ExpressionType.python_object(),
        "numpy_arrays": ExpressionType._infer_from_py_type(np.ndarray),
        "np_int": ExpressionType.integer(),
        "np_string": ExpressionType.string(),
        "np_object": ExpressionType._infer_from_py_type(MyObj),
        "np_nested": ExpressionType._infer_from_py_type(np.ndarray),
        "pa_int": ExpressionType.integer(),
        "pa_nested": ExpressionType._infer_from_py_type(list),
        "pa_int_chunked": ExpressionType.integer(),
        "pa_nested_chunked": ExpressionType._infer_from_py_type(list),
    }
