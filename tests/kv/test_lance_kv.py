...
# Native extension is required for kv_*_with_name, which goes through Rust UDFs
try:
    import daft.daft as native  # noqa: F401
except Exception:
    pytest.skip("daft.daft native extension is required for Lance KV tests", allow_module_level=True)
