# TODO: [RUST-INT][PY] Enable after adding support for Python objects and UDFs
...
#     assert daft_df.schema()["id"].dtype == DataType.int64()
...
#     daft_df = DataFrame.from_pydict(data).repartition(repartition_nparts)
#     assert daft_df.schema()["id"].dtype == DataType.int64()
#     assert daft_df.schema()["features"].dtype == DataType.python(np.ndarray)
#     pd_df = pd.DataFrame.from_dict(data)
#     daft_pd_df = daft_df.to_pandas()
#     assert_df_equals(daft_pd_df, pd_df, sort_key="id")
