...
def test_list_join():
    ...
    result = table.eval_expression_list([daft.functions.list_join(col("col"), ",")])
...
def test_list_join_other_col():
    ...
    result = table.eval_expression_list([daft.functions.list_join(col("col"), col("delimiter"))])
...
def test_list_join_bad_type():
    ...
    with pytest.raises(ValueError):
        table.eval_expression_list([daft.functions.list_join(col("col"), ",")])
