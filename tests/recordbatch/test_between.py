...
@pytest.mark.parametrize(
    ...
    [
        ...
        pytest.param([1.0, 2.0, 3.0, 4.0], None, 1, [None, False, False, False], id="FloatNullInt"),
...
def test_between_bad_input() -> None:
    ...
    with pytest.raises(TypeError):
        daft_recordbatch = daft_recordbatch.eval_expression_list([col("a").between(object(), 1)])
