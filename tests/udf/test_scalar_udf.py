...
def test_scalar_udf_alternative_signature():
    @daft.func
    def my_stringify_and_sum(a: int, b: int) -> str:
        return f"{a + b}"
...
def test_scalar_udf_with_literal():
    @daft.func()
    def my_stringify_and_sum(a: int, b: int) -> str:
        return f"{a + b}"
...
def test_scalar_udf_should_infer_dtype_from_function():
    @daft.func()
...
def test_scalar_udf_override_return_dtype():
...
def test_scalar_udf_literal_eval():
    @daft.func
    def my_stringify_and_sum(a: int, b: int) -> str:
        return f"{a + b}"
