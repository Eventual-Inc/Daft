...
class TestDistributedIndexing:
    ...
    def test_build_distributed_index_search_functionality(self, multi_fragment_lance_dataset):
        ...
        # `list_indices()` is deprecated and reports "Unknown" for distributed-committed
        # indices; `index_stats` is the supported way to read the index type back.
    ...
    def test_build_distributed_index_replace_true_overwrite_existing(self, multi_fragment_lance_dataset):
        ...
        # See note above: read the type through `index_stats`, not the deprecated listing.
