...
class TestDistributedIndexing:
    ...
    def test_build_distributed_index_auto_adjust_workers(self, temp_dir):
        ...
        create_scalar_index(
            ...
            column="text",
            index_type="INVERTED",
            max_concurrency=10,  # More than the 2 fragments
        )
    ...
    def test_build_distributed_index_partition_num(self, multi_fragment_lance_dataset):
        """Test building distributed index with partition_num parameter."""
        dataset_uri = multi_fragment_lance_dataset

        # Build distributed index with custom partition_num
        create_scalar_index(
            uri=dataset_uri,
            column="text",
            index_type="INVERTED",
