...
IOConfig | daft | (s3: S3Config | None=None, azure: AzureConfig | None=None, gcs: GCSConfig | None=None, http: HTTPConfig | None=None, unity: UnityConfig | None=None, hf: HuggingFaceConfig | None=None, disable_suffix_range: bool | None=None, tos: TosConfig | None=None, gravitino: GravitinoConfig | None=None, cos: CosConfig | None=None, goosefs: GooseFSConfig | None=None, opendal_backends: dict[str, dict[str, str]] | None=None, protocol_aliases: dict[str, str] | None=None) | Configuration for the native I/O layer, e.g. | toplevel.md#ioconfig
...
session | daft | (submodule) |  | toplevel.md#session
...
sql | daft | (submodule) |  | toplevel.md#sql
...
udaf | daft | (submodule) |  | toplevel.md#udaf
udf | daft | (submodule) |  | toplevel.md#udf
