...
class PyRecordBatch:
    ...
    @staticmethod
    def from_pylist_series(dict: dict[str, PySeries], provenance_columns: set[str] | None = None) -> PyRecordBatch: ...
    @staticmethod
    def from_pyseries_list(list: list[PySeries], provenance_columns: set[str] | None = None) -> PyRecordBatch: ...
