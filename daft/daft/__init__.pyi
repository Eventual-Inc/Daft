...
# ---
# expr.geometry namespace
# ---
def geo_op(expr: PyExpr, op: Any) -> PyExpr: ...
def geo_op_binary(expr: PyExpr, other: PyExpr, op: Any) -> PyExpr: ...
def geo_encode(expr: PyExpr, text: bool, raise_on_error: bool) -> PyExpr: ...
def geo_decode(expr: PyExpr, raise_on_error: bool) -> PyExpr: ...
