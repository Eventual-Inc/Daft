...
class DistributedPhysicalPlan:
    ...
    def run_plan(self, psets: dict[str, list[RayPartitionRef]], worker_manager: RayWorkerManager) -> AsyncIterator[tuple[ray.ObjectRef, int, int]]: ...
...
class RaySwordfishWorker:
    def __init__(self, worker_id: str, actor_handle: RaySwordfishActorHandle, num_cpus: int, memory_bytes: int): ...
