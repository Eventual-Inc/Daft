...
class PyDaftExecutionConfig:
    ...
    @property
    def celeborn_lm_host(self) -> str | None: ...
    @property
    def celeborn_lm_port(self) -> int | None: ...
    @property
    def celeborn_app_id(self) -> str | None: ...
    @property
    def celeborn_properties(self) -> list[tuple[str, str]] | None: ...
