...
class PyDaftContext:
    ...
    def notify_checkpoint_committed(self, query_id: str, checkpoint_ids: list[str], duration_us: int) -> None: ...
    def notify_checkpoint_failed(self, query_id: str, checkpoint_ids: list[str], error: str) -> None: ...
