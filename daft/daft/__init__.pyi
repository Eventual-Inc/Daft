...
def named_expr(name: str, expr: PyExpr) -> PyExpr: ...
...
class PyRecordBatch:
    ...
    @staticmethod
    def from_pyseries_list(lst: list[PySeries]) -> PyRecordBatch: ...
...
class PyScalarFunction:
    def __call__(self, *args: list[PyExpr], **kwargs: dict[str, PyExpr]) -> PyExpr: ...
