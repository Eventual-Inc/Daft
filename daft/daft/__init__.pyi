...
class SwordfishStage:
    def update(self, num_rows: int) -> None: ...
    def next_plan(self) -> LocalPhysicalPlan | None: ...
    def is_done(self) -> bool: ...

class DistributedPhysicalPlanner:
    @staticmethod
    def from_logical_plan_builder(
        builder: LogicalPlanBuilder, config: PyDaftExecutionConfig
    ) -> DistributedPhysicalPlanner: ...
    def next_stage(self) -> SwordfishStage | None: ...
    def is_done(self) -> bool: ...
