...
class PyGeospatialMode:
    """Geospatial mode describing dimension, coordinate type, and metadata for geospatial types."""

    @staticmethod
    def from_user_defined_mode(
        dimension: str,
        coord_type: str,
        crs: str | None = None,
...
class PyDataType:
    ...
    @staticmethod
    def wkt(mode: PyGeospatialMode | None = None) -> PyDataType: ...
    @staticmethod
    def wkb(mode: PyGeospatialMode | None = None) -> PyDataType: ...
    @staticmethod
    def point(mode: PyGeospatialMode | None = None) -> PyDataType: ...
    @staticmethod
    def linestring(mode: PyGeospatialMode | None = None) -> PyDataType: ...
    @staticmethod
    def polygon(mode: PyGeospatialMode | None = None) -> PyDataType: ...
    @staticmethod
    def multipoint(mode: PyGeospatialMode | None = None) -> PyDataType: ...
    @staticmethod
    def multilinestring(mode: PyGeospatialMode | None = None) -> PyDataType: ...
    @staticmethod
    def multipolygon(mode: PyGeospatialMode | None = None) -> PyDataType: ...
    @staticmethod
    def geometry_collection(mode: PyGeospatialMode | None = None) -> PyDataType: ...
    @staticmethod
    def geometry(mode: PyGeospatialMode | None = None) -> PyDataType: ...
    @staticmethod
    def rect(mode: PyGeospatialMode | None = None) -> PyDataType: ...
