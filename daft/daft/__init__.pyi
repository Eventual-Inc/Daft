...
class PyTable:
    ...
    def sample_by_fraction(
        self, fraction: float, with_replacement: bool, over_sample: bool, seed: int | None
    ) -> PyTable: ...
    def sample_by_size(self, size: int, with_replacement: bool, over_sample: bool, seed: int | None) -> PyTable: ...
...
class PyMicroPartition:
    ...
    def sample_by_size(
        self, size: int, with_replacement: bool, over_sample: bool, seed: int | None
    ) -> PyMicroPartition: ...
