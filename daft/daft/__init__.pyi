...
class PySeries:
    ...
    @staticmethod
    def from_pylist_of_files(name: str, pylist: list[Any]) -> PySeries: ...
...
class PyDaftFile:
    ...
    @staticmethod
    def _from_tuple(tuple: tuple[Any]) -> PyDaftFile: ...
    def tell(self) -> int: ...
    def close(self) -> None: ...
...
def deserialize_literals(b: bytes) -> list: ...
def serialize_literal(lit: Any) -> bytes: ...