...
class PyDaftExecutionConfig:
    ...
    @property
    def flight_shuffle_server_side_repartition(self) -> bool: ...
    @property
    def flight_shuffle_mode_switch_threshold_bytes(self) -> int: ...
    @property
    def flight_shuffle_server_repartition_threshold_bytes(self) -> int: ...
    @property
