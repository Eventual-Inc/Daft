...
class PyTableSource:
    def __init__(self): ...
    @staticmethod
    def from_schema(schema: PySchema) -> PyTableSource: ...
    @staticmethod
...
class PySession:
    ...
    @staticmethod
    def empty() -> PySession: ...
    def current_catalog(self) -> PyCatalog: ...
    def current_namespace(self) -> PyNamespace: ...
    def attach(self, name: str, catalog: PyCatalog): ...
    def detach(self, name: str): ...
    def create_catalog(self, name: str) -> PyCatalog: ...
    def create_namespace(self, name: str) -> PyNamespace: ...
    def create_table(self, name: str, source: PyTableSource): ...
    def create_temp_table(self, name: str, source: PyTableSource): ...
    def get_catalog(self, name: str) -> PyCatalog: ...
    def get_namespace(self, name: str) -> PyNamespace: ...
    def get_table(self, name: PyIdentifier) -> PyTable: ...
    def list_catalogs(self, pattern: None | str = None) -> list[PyCatalog]: ...
    def list_namespaces(self, pattern: None | str = None) -> list[PyNamespace]: ...
    def list_tables(self, pattern: None | str = None) -> list[PyTable]: ...
