...
class InProgressSwordfishPlan:
    def __init__(self) -> None: ...
    def get_result(self, input_id: int) -> PyMicroPartition: ...
    def put_input(self, morsel_id: int, input: ScanTask) -> None: ...
