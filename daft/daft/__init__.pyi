...
class PyDataType:
    ...
    @staticmethod
    def sparse_tensor(
        dtype: PyDataType, shape: tuple[int, ...] | None = None, is_indices_offsets: bool = False
    ) -> PyDataType: ...
    @staticmethod
...
class PySession:
    ...
    def has_table(self, name: PyIdentifier) -> bool: ...
    def list_catalogs(self, pattern: None | str = None) -> list[str]: ...
    def list_tables(self, pattern: None | str = None) -> list[PyIdentifier]: ...
