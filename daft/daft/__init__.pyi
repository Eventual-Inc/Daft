...
class RayTaskResult:
    @staticmethod
    def success_materialized(ray_part_refs: list[RayPartitionRef], stats: bytes) -> RayTaskResult: ...
    @staticmethod
    def success_shuffle_ray(shuffle_part_refs: list[RayPartitionRef], stats: bytes) -> RayTaskResult: ...
    @staticmethod
    def success_shuffle_flight(shuffle_part_refs: list[FlightShufflePartitionRef], stats: bytes) -> RayTaskResult: ...
    @staticmethod
...
class PyResultReceiver:
    ...
    async def try_finish_with_shuffle_metadata(
        ...
        PyExecutionStats,
        list[tuple[object | None, int | None, int, int]] | list[FlightShufflePartitionRef] | None,
    ]: ...
