...
class DistributedPhysicalPlanRunner:
    ...
    def run_plan(
        ...
        psets: dict[str, list[RayPartitionRef]],
...
class PyContextState:
    @staticmethod
    def _from_serialized(serialized: bytes) -> PyContextState: ...

class PyDaftContext:
    def __init__(self) -> None: ...
    @property
    def _daft_execution_config(self) -> PyDaftExecutionConfig: ...
    @_daft_execution_config.setter
    def _daft_execution_config(self, value: PyDaftExecutionConfig) -> None: ...
    @property
    def _daft_planning_config(self) -> PyDaftPlanningConfig: ...
    @_daft_planning_config.setter
    def _daft_planning_config(self, value: PyDaftPlanningConfig) -> None: ...
    @property
    def state(self) -> PyContextState: ...
