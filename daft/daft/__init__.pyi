...
class RayTaskResult:
    ...
    @staticmethod
    def ray_exchange_success(exchange_part_refs: list[RayPartitionRef], stats: bytes) -> RayTaskResult: ...
    @staticmethod
    def flight_exchange_success(exchange_part_refs: list[FlightShufflePartitionRef], stats: bytes) -> RayTaskResult: ...
    @staticmethod
...
class PyResultReceiver:
    ...
    async def try_finish_with_exchange_metadata(
        self,
    ) -> tuple[PyExecutionStats, list[tuple[object | None, int, int]] | None]: ...

class ExchangeWriteInfo:
    @property
...
class LocalPhysicalPlan:
    ...
    def exchange_write_info(self) -> ExchangeWriteInfo | None: ...
