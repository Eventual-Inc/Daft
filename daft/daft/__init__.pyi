...
class DistributedPhysicalPlan:
    @staticmethod
    def from_logical_plan_builder(builder: LogicalPlanBuilder, config: PyDaftExecutionConfig) -> DistributedPhysicalPlan: ...
    def to_local_physical_plans(self) -> list[LocalPhysicalPlan]: ...
