...
class LogicalPlanBuilder:
    ...
    def with_checkpoint(self, store_config: CheckpointStoreConfig, key_column: str) -> LogicalPlanBuilder: ...
...
class PyDaftContext:
    ...
    def notify_exec_operator_start(self, query_id: str, node_id: int, name: str) -> None: ...
    def notify_exec_operator_end(self, query_id: str, node_id: int, name: str) -> None: ...
