...
class PyDataType:
    ...
    def get_image_inner(self) -> tuple[ImageMode | None, int | None, int | None]: ...
    def is_list(self) -> builtins.bool: ...
    def get_list_inner(self) -> PyDataType: ...
    def is_tensor(self) -> builtins.bool: ...
    def get_tensor_inner(self) -> tuple[PyDataType, tuple[int, ...] | None]: ...
    def is_fixed_shape_tensor(self) -> builtins.bool: ...
    def get_fixed_shape_tensor_inner(self) -> tuple[PyDataType, tuple[int, ...]]: ...
    def is_sparse_tensor(self) -> builtins.bool: ...
    def get_sparse_tensor_inner(self) -> tuple[PyDataType, builtins.bool]: ...
    def is_fixed_shape_sparse_tensor(self) -> builtins.bool: ...
    def get_fixed_shape_sparse_tensor_inner(self) -> tuple[PyDataType, tuple[int, ...], builtins.bool]: ...
    ...
    def get_duration_inner(self) -> PyTimeUnit: ...
    def is_timestamp(self) -> builtins.bool: ...
    def get_timestamp_inner(self) -> tuple[PyTimeUnit, str | None]: ...
    def is_fixed_size_binary(self) -> builtins.bool: ...
    def get_fixed_size_binary_inner(self) -> int: ...
    def is_fixed_size_list(self) -> builtins.bool: ...
    def get_fixed_size_list_inner(self) -> tuple[PyDataType, int]: ...
    def is_map(self) -> builtins.bool: ...
    def get_map_inner(self) -> tuple[PyDataType, PyDataType]: ...
    def is_struct(self) -> builtins.bool: ...
    def get_struct_inner(self) -> dict[str, PyDataType]: ...
    def is_time(self) -> builtins.bool: ...
    def get_time_inner(self) -> PyTimeUnit: ...
    def is_embedding(self) -> builtins.bool: ...
    def get_embedding_inner(self) -> tuple[PyDataType, int]: ...
    def is_decimal(self) -> builtins.bool: ...
    def get_decimal_inner(self) -> tuple[int, int]: ...
    def is_extension(self) -> builtins.bool: ...
    def get_extension_inner(self) -> tuple[str, PyDataType, str | None]: ...
