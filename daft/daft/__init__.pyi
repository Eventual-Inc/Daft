...
def write_many_ipc_files(py_partitions_and_paths: list[tuple[PyMicroPartition, str]]) -> None: ...
def read_many_ipc_files(paths: list[str]) -> list[PyMicroPartition]: ...
def write_many_ipc_streams(py_partitions: list[PyMicroPartition]) -> list[bytes]: ...
