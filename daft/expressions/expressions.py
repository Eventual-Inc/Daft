...
def col(name: str) -> Expression:
    ...
    See [Column Wildcards](/docs/core_concepts.md#selecting-columns-using-wildcards) for details on wildcards.
...
class Expression:
    ...
    def to_struct(*fields: Expression | builtins.str) -> Expression:
        ...
        !!! tip "See also [struct][daft.expressions.struct]"
        """
        warnings.warn(
    ...
    def __getitem__(self, key) -> Expression:
        """Syntactic sugar for [Expression.list.get][daft.expressions.expressions.ExpressionListNamespace.get] and [Expression.struct.get][daft.expressions.expressions.ExpressionStructNamespace.get].
        ...
        !!! tip "See also [list.get][daft.expressions.expressions.ExpressionListNamespace.get] and [struct.get][daft.expressions.expressions.ExpressionStructNamespace.get]"
        """
        key_type = type(key)
    ...
    def cast(self, dtype: DataTypeLike) -> Expression:
        ...
        !!! note
            ...
            - If a string is provided, it will use the sql engine to parse the string into a data type. See the [SQL Reference](/docs/sql/datatypes.md) for supported datatypes.
    ...
    def hash(self, seed: Any | None = None) -> Expression:
        ...
        !!! note "Null values will produce a hash value instead of being propagated as null."
    ...
    def encode(self, codec: Literal["deflate", "gzip", "gz", "utf-8", "zlib"]) -> Expression:
        ...
        !!! note "This inputs either a string or binary and returns a binary."
    ...
    def decode(self, codec: Literal["deflate", "gzip", "gz", "utf-8", "zlib"]) -> Expression:
        ...
        !!! note "This inputs a binary and returns either a binary or string. For now, only decoding with 'utf-8' returns a string."
...
class ExpressionUrlNamespace(ExpressionNamespace):
    ...
    def upload(
        ...
        will be returned as a column of string paths that is compatible with the [.url.download()][daft.expressions.expressions.ExpressionURLNamespace.download] Expression.
...
class ExpressionFloatNamespace(ExpressionNamespace):
    def is_nan(self) -> Expression:
        ...
        !!! note "Nulls will be propagated! I.e. this operation will return a null for null values."
...
class ExpressionStringNamespace(ExpressionNamespace):
    ...
    def concat(self, other: str | Expression) -> Expression:
        ...
        !!! note "Another (easier!) way to invoke this functionality is using the Python `+` operator which is
            aliased to using [.str.concat][daft.expressions.expressions.ExpressionStringNamespace.concat]."
    ...
    def extract(self, pattern: str | Expression, index: int = 0) -> Expression:
        ...
        !!! tip "See also [extract_all][daft.expressions.expressions.ExpressionStringNamespace.extract_all]"
        """
        pattern_expr = Expression._to_expression(pattern)
    ...
    def extract_all(self, pattern: str | Expression, index: int = 0) -> Expression:
        ...
        !!! tip "See also [extract][daft.expressions.expressions.ExpressionStringNamespace.extract]"
        """
        pattern_expr = Expression._to_expression(pattern)
    ...
    def find(self, substr: str | Expression) -> Expression:
        ...
        !!! note "The returned index is 0-based. If the substring is not found, -1 is returned."
    ...
    def rpad(self, length: int | Expression, pad: str | Expression) -> Expression:
        ...
        !!! note "If the string is longer than the specified length, it will be truncated. The pad character must be a single character."
    ...
    def lpad(self, length: int | Expression, pad: str | Expression) -> Expression:
        ...
        !!! note "If the string is longer than the specified length, it will be truncated on the right. The pad character must be a single character."
    ...
    def like(self, pattern: str | Expression) -> Expression:
        ...
        !!! note "Use % as a multiple-character wildcard or _ as a single-character wildcard."
    ...
    def substr(self, start: int | Expression, length: int | Expression | None = None) -> Expression:
        ...
        !!! note "If `length` is not provided, the substring will include all characters from `start` to the end of the string."
    ...
    def to_date(self, format: str) -> Expression:
        ...
        !!! note "The format must be a valid date format string. See <https://docs.rs/chrono/latest/chrono/format/strftime/index.html>"
    ...
    def to_datetime(self, format: str, timezone: str | None = None) -> Expression:
        ...
        !!! note "The format must be a valid datetime format string. See <https://docs.rs/chrono/latest/chrono/format/strftime/index.html>"
    ...
    def normalize(
        ...
        *,
        ...
        !!! note "All processing options are off by default."
    ...
    def tokenize_encode(
        ...
        *,
        ...
        !!! note "If using this expression with Llama 3 tokens, note that Llama 3 does some extra preprocessing on strings in certain edge cases. This may result in slightly different encodings in these cases."
...
class ExpressionListNamespace(ExpressionNamespace):
    ...
    def lengths(self) -> Expression:
        ...
        !!! warning "DEPRECATED: Please use [Expression.list.length][daft.expressions.expressions.ExpressionListNamespace.length] instead"
    ...
    def unique(self) -> Expression:
        ...
        !!! tip "See also [list.distinct][daft.expressions.expressions.ExpressionListNamespace.distinct]"
        """
