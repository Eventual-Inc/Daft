...
from daft.catalog import Catalog, TableSource
...
class SQLCatalog:
    ...
    DEPRECATED: This features is deprecated, please using Catalog.from_pydict() in daft.catalog.
    """
    ...
    def __init__(self, tables: dict) -> None:
        ...
        self._catalog = Catalog.from_pydict(tables)

    def __str__(self) -> str:
        return str(self._catalog)

    def register_table(self, name: str, df: DataFrame):
        """DEPRECATED: Please use daft.catalog's Catalog.create_table API."""
        self._catalog.create_table(name, TableSource._from_df(df))
