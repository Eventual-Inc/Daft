...
np_arrow_type = pa.struct([("shape", pa.list_(pa.int64())), ("type", pa.string()), ("data", pa.binary())])

translation: Dict[type, pa.lib.DataType] = {PIL.Image.Image: DaftPILImage(), np.ndarray: pa.binary()}
...
reduce_type = {PIL.Image.Image: encode_pil, np.ndarray: lambda x: x.tobytes()}
