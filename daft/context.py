...
def set_execution_config(
    ...
    shuffle_map_spill_threshold: int | None = None,
) -> DaftContext:
    ...
    Args:
        ...
        shuffle_map_spill_threshold: Memory threshold in bytes for shuffle aggregation spill. Defaults to None (no spill).
    """
    ...
    with ctx._lock:
        ...
        new_daft_execution_config = old_daft_execution_config.with_config_values(
            ...
            shuffle_map_spill_threshold=shuffle_map_spill_threshold,
        )
