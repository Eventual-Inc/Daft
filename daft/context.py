...
def set_execution_config(
    ...
    Args:
        ...
        shuffle_algorithm: The shuffle algorithm to use. Defaults to "auto", which will let Daft determine the algorithm. Options are "map_reduce", "pre_shuffle_merge", "flight_shuffle", and "flight_shuffle_pre_shuffle_merge".
