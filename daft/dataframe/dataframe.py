...
class DataFrame:
    ...
    def _agg_inputs_to_expressions(
        ...
        def agg_tuple_to_expression(agg_tuple: Tuple[ColumnInputType, str]) -> Expression:
            warnings.warn(
        ...
        return [agg_tuple_to_expression(col) if isinstance(col, tuple) else col for col in columns]  # type: ignore
