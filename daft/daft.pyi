...
class PyExpr:
    ...
    def tokenize_encode(self, tokens_path: str) -> PyExpr: ...
    def tokenize_decode(self, tokens_path: str) -> PyExpr: ...
...
class PySeries:
    ...
    def tokenize_encode(self, tokens_path: str) -> PySeries: ...
    def tokenize_decode(self, tokens_path: str) -> PySeries: ...
