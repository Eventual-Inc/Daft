...
class PyTable:
    ...
    def sample(self, fraction: float, with_replacement: bool, seed: int | None) -> PyTable: ...
...
class PyMicroPartition:
    ...
    def sample(self, fraction: float, with_replacement: bool, seed: int | None) -> PyMicroPartition: ...
