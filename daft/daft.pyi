...
class PyExpr:
    ...
    def utf8_to_date(self, format: PyExpr) -> PyExpr: ...
    def utf8_to_datetime(self, format: PyExpr) -> PyExpr: ...
...
class PySeries:
    ...
    def utf8_to_date(self, format: PySeries) -> PySeries: ...
    def utf8_to_datetime(self, format: PySeries) -> PySeries: ...
