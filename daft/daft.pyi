...
class PyTable:
    ...
    def pivot(self, group_by: PyExpr, pivot_column: PyExpr, values_column: PyExpr) -> PyTable: ...
...
class PyMicroPartition:
    ...
    def pivot(self, group_by: PyExpr, pivot_column: PyExpr, values_column: PyExpr) -> PyMicroPartition: ...
