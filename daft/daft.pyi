...
def tokenize_encode(expr: PyExpr, tokens_path: str, io_config: IOConfig | None) -> PyExpr: ...
def tokenize_decode(expr: PyExpr, tokens_path: str, io_config: IOConfig | None) -> PyExpr: ...
