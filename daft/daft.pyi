...
class PyExpr:
    ...
    def utf8_replace_all(self, pattern: PyExpr, replacement: PyExpr, regex: bool) -> PyExpr: ...
...
class PySeries:
    ...
    def utf8_replace_all(self, pattern: PySeries, replacement: PySeries, regex: bool) -> PySeries: ...
