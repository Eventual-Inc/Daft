...
class PyExpr:
    ...
    def min(self) -> PyExpr: ...
    def max(self) -> PyExpr: ...
    def shift_left(self, bits: PyExpr) -> PyExpr: ...
    def shift_right(self, bits: PyExpr) -> PyExpr: ...
...
class PySeries:
    ...
    def shift_left(self, bits: PySeries) -> PySeries: ...
    def shift_right(self, bits: PySeries) -> PySeries: ...
