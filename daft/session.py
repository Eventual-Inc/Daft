...
class Session:
    ...
    def attach(self, object: Catalog | Provider | Table | Func | DataFrame, alias: str | None = None) -> None:
    ...
    def attach_function(self, function: Func, alias: str | None = None) -> None:
...
def attach(object: Catalog | Provider | Table | Func | DataFrame, alias: str | None = None) -> None:
...
def attach_function(function: Func, alias: str | None = None) -> None:
    """Attaches a Python function as a UDF in the current session."""
