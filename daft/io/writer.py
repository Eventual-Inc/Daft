...
class FileWriterBase:
    def __init__(
        ...
        self.current_writer: Optional[Union[papq.ParquetWriter, pacsv.CSVWriter]] = None
...
class ParquetFileWriter(FileWriterBase):
    ...
    def _create_writer(self, schema: pa.Schema) -> papq.ParquetWriter:
        file_path = f"{self.resolved_path}/{self.file_name}"
        return papq.ParquetWriter(
            file_path,
            schema,
