...
from ..pushdown.pushdowns import SupportsPushdownFilters
...
class LanceDBScanOperator(ScanOperator, SupportsPushdownFilters):
    ...
    def as_pushdown_filter(self) -> Optional[SupportsPushdownFilters]:
        return self
    ...
    def pushed_filters(self) -> list[PyExpr]:
        return self._pushed_filters if self._pushed_filters else []
