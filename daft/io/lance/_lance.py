...
def create_scalar_index(
    ...
    **kwargs: Any,
    ...
    Args:
        ...
        partition_num: Optional number of partitions to use when repartitioning fragment batches before
            execution. Values greater than 1 enable additional parallelism on distributed runners.
    ...
    Examples:
        ...
        >>> daft.io.lance.create_scalar_index(
        ...     "s3://my-bucket/dataset/", column="description", fragment_group_size=8, partition_num=16
        ... )
