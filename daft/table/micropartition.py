...
class MicroPartition:
    ...
    def pivot(self, group_by: Expression, pivot_column: Expression, values_column: Expression) -> MicroPartition:
        group_by_pyexpr = group_by._expr
        pivot_column_pyexpr = pivot_column._expr
        values_column_pyexpr = values_column._expr
        return MicroPartition._from_pymicropartition(
            self._micropartition.pivot(group_by_pyexpr, pivot_column_pyexpr, values_column_pyexpr)
        )
