...
pub fn create_pyarrow_file_writer(
    ...
    match format {
        #[cfg(feature = "python")]
        FileFormat::Parquet => Ok(Box::new(super::pyarrow::PyArrowWriter::new_parquet_writer(
            root_dir,
            file_idx,
            compression,
            io_config,
        ...
        FileFormat::Csv => {
            ...
            Ok(Box::new(super::pyarrow::PyArrowWriter::new_csv_writer(
...
fn parse_url_and_config(
    ...
    match source_type {
        ...
        daft_io::SourceType::Gravitino => {
            ...
            super::storage_backend::GravitinoStorageBackend::parse_gravitino_url_and_config(
                path.as_ref(),
                io_config,
            )
        }
