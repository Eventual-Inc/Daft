...
use crate::runtime_stats::{CountingReceiver, CountingSender, RuntimeStatsContext};
...
impl Sender<Arc<MicroPartition>> {
...
impl<T: Clone> Receiver<T> {
    ...
    pub(crate) fn into_stream(self) -> impl futures::Stream<Item = T> {
        self.0.into_stream()
    }
}

impl Receiver<Arc<MicroPartition>> {
