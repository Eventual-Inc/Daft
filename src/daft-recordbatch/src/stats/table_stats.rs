...
use super::{DaftCoreComputeSnafu, column_stats::ColumnRangeStatistics};
...
impl TableStatistics {
    ...
    pub fn union(&self, other: &Self) -> super::Result<Self> {
        if self.schema != other.schema {
            return Err(super::Error::DaftCoreCompute {
    ...
    pub fn eval_expression_list(&self, exprs: &[BoundExpr]) -> super::Result<Self> {
        let columns = exprs
            .iter()
    ...
    pub fn eval_expression(&self, expr: &BoundExpr) -> super::Result<ColumnRangeStatistics> {
        match expr.as_ref() {
    ...
    pub fn cast_to_schema(&self, schema: &Schema) -> super::Result<Self> {
        #[allow(deprecated)]
...
mod test {
    ...
    use super::super::{DaftCoreComputeSnafu, TruthValue};

    #[test]
    fn test_equal() -> super::super::Result<()> {
    ...
    #[test]
    fn test_not_null_literal_is_maybe() -> super::super::Result<()> {
    ...
    #[test]
    fn test_missing_string_col_eq_is_maybe() -> super::super::Result<()> {
    ...
    #[test]
    fn test_missing_int_col_eq_is_maybe() -> super::super::Result<()> {
