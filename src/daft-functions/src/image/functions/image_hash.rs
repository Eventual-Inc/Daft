...
use super::super::ops::hash_output_bytes;
...
impl ScalarUDF for ImageHash {
    ...
    fn call(
        ...
        super::super::series::image_hash(&input, method, hash_size, binbits, segments)
    }
    ...
    fn get_return_field(
        ...
        match &field.dtype {
            ...
            _ => Err(daft_common::error::DaftError::TypeError(format!(
