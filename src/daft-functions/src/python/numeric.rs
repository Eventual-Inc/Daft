...
simple_python_wrapper!(expm1, crate::numeric::exp::expm1, [expr: PyExpr]);
...
simple_python_wrapper!(signum, crate::numeric::sign::signum, [expr: PyExpr]);
simple_python_wrapper!(negate, crate::numeric::sign::negate, [expr: PyExpr]);
...
simple_python_wrapper!(log1p, crate::numeric::log::log1p, [expr: PyExpr]);
...
simple_python_wrapper!(sinh, crate::numeric::trigonometry::sinh, [expr: PyExpr]);
simple_python_wrapper!(cosh, crate::numeric::trigonometry::cosh, [expr: PyExpr]);
simple_python_wrapper!(tanh, crate::numeric::trigonometry::tanh, [expr: PyExpr]);
