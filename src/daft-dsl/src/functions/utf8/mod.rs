...
impl Utf8Expr {
    ...
    pub fn get_evaluator(&self) -> Box<dyn FunctionEvaluator> {
        ...
        match self {
            ...
            Split(_) => Box::new(SplitEvaluator {}),
            Match => Box::new(MatchEvaluator {}),
            Extract(_) => Box::new(ExtractEvaluator {}),
            ExtractAll(_) => Box::new(ExtractAllEvaluator {}),
            Replace(_) => Box::new(ReplaceEvaluator {}),
            Length => Box::new(LengthEvaluator {}),
            Lower => Box::new(LowerEvaluator {}),
            Upper => Box::new(UpperEvaluator {}),
            Lstrip => Box::new(LstripEvaluator {}),
            Rstrip => Box::new(RstripEvaluator {}),
            Reverse => Box::new(ReverseEvaluator {}),
            Capitalize => Box::new(CapitalizeEvaluator {}),
            Left => Box::new(LeftEvaluator {}),
            Right => Box::new(RightEvaluator {}),
            Find => Box::new(FindEvaluator {}),
            Rpad => Box::new(RpadEvaluator {}),
            Lpad => Box::new(LpadEvaluator {}),
            Repeat => Box::new(RepeatEvaluator {}),
            Like => Box::new(LikeEvaluator {}),
            Ilike => Box::new(IlikeEvaluator {}),
            Substr => Box::new(SubstrEvaluator {}),
            ToDate(_) => Box::new(ToDateEvaluator {}),
            ToDatetime(_, _) => Box::new(ToDatetimeEvaluator {}),
            Normalize(_) => Box::new(NormalizeEvaluator {}),
        }
    }
}
