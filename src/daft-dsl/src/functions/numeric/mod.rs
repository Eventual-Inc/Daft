...
impl NumericExpr {
    ...
    pub fn get_evaluator(&self) -> &dyn FunctionEvaluator {
        match self {
            Self::Abs => &AbsEvaluator {},
            Self::Ceil => &CeilEvaluator {},
            Self::Floor => &FloorEvaluator {},
            Self::Sign => &SignEvaluator {},
            Self::Round(_) => &RoundEvaluator {},
            Self::Sqrt => &SqrtEvaluator {},
            Self::Sin => &TrigonometryEvaluator(TrigonometricFunction::Sin),
            Self::Cos => &TrigonometryEvaluator(TrigonometricFunction::Cos),
            Self::Tan => &TrigonometryEvaluator(TrigonometricFunction::Tan),
            Self::Cot => &TrigonometryEvaluator(TrigonometricFunction::Cot),
            Self::ArcSin => &TrigonometryEvaluator(TrigonometricFunction::ArcSin),
            Self::ArcCos => &TrigonometryEvaluator(TrigonometricFunction::ArcCos),
            Self::ArcTan => &TrigonometryEvaluator(TrigonometricFunction::ArcTan),
            Self::ArcTan2 => &Atan2Evaluator {},
            Self::Radians => &TrigonometryEvaluator(TrigonometricFunction::Radians),
            Self::Degrees => &TrigonometryEvaluator(TrigonometricFunction::Degrees),
            Self::Log2 => &LogEvaluator(log::LogFunction::Log2),
            Self::Log10 => &LogEvaluator(log::LogFunction::Log10),
            Self::Log(_) => &LogEvaluator(log::LogFunction::Log),
            Self::Ln => &LogEvaluator(log::LogFunction::Ln),
            Self::Exp => &ExpEvaluator {},
            Self::ArcTanh => &TrigonometryEvaluator(TrigonometricFunction::ArcTanh),
            Self::ArcCosh => &TrigonometryEvaluator(TrigonometricFunction::ArcCosh),
            Self::ArcSinh => &TrigonometryEvaluator(TrigonometricFunction::ArcSinh),
        }
    }
}
