...
use super::runners::{self, DAFT_RUNNER, NativeRunner, RayRunner, Runner, RunnerConfig};
...
pub fn set_runner_ray(
    ...
    let runner = Arc::new(Runner::Ray(RayRunner::try_new(address, force_client_mode)?));
