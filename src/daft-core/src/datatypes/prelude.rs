...
pub use crate::datatypes::{
    ...
    FixedShapeSparseTensorType, FixedShapeTensorType, GeometryCollectionType, GeometryType,
    ImageType, IntervalType, LineStringType, MapType, MultiLineStringType, MultiPointType,
    MultiPolygonType, PointType, PolygonType, RectType, SparseTensorType, TensorType, TimeType,
    TimestampType, UuidType, WKBType, WKTType,
    logical::{DaftGeometryType, DaftImageryType},
};
