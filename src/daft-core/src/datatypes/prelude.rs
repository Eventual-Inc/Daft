...
pub use crate::datatypes::{
    ...
    FixedShapeSparseTensorType, FixedShapeTensorType, GeometryType, ImageType, IntervalType,
    MapType, SparseTensorType, TensorType, TimeType, TimestampType, UuidType,
    logical::DaftImageryType,
};
