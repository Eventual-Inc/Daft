...
macro_rules! with_match_daft_types {(
    ...
    match $key_type {
        ...
        Interval(IntervalUnit::DayTime) => __with_ty__! { DayTimeType },
        Interval(IntervalUnit::MonthDayNano) => __with_ty__! { MonthDayNanoType },
        Interval(IntervalUnit::YearMonth) => __with_ty__! { Int32Type },
