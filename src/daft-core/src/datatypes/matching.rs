...
macro_rules! with_match_daft_types {
    (
        ...
        use $crate::file::{MediaType, UnknownFileType, VideoFileType, AudioFileType, ImageFileType, Hdf5FileType, McapFileType};
        ...
        match $key_type {
            ...
            DataType::File(MediaType::Mcap) => __with_ty__! { McapFileType },
...
macro_rules! with_match_file_types {
    (
        ...
        use $crate::datatypes::*;
        use $crate::datatypes::DataType;
        use $crate::file::{MediaType, MediaTypeUnknown, MediaTypeVideo, MediaTypeAudio, MediaTypeImage, MediaTypeHdf5, MediaTypeMcap};
        ...
        match $key_type {
            ...
            DataType::File(MediaType::Mcap) => __with_ty__! { MediaTypeMcap },
