...
use super::{
    ...
    GeographyType, GeometryCollectionType, GeometryType, ImageType, LineStringType, MapType,
    MultiLineStringType, MultiPointType, MultiPolygonType, PointType, PolygonType, RectType,
    SparseTensorType, TensorType, TimeType, TimestampType, WKBType, WKTType,
};
use crate::{
...
pub type GeographyArray = LogicalArray<GeographyType>;
...
impl DaftGeometryType for GeographyType {}
