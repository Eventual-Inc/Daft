...
impl_daft_logical_data_array_datatype!(COOSparseTensorType, Unknown, StructType);
impl_daft_logical_data_array_datatype!(FixedShapeCOOSparseTensorType, Unknown, StructType);
