...
use crate::py_serde::{deserialize_py_object, serialize_py_object};
...
pub struct S3Credentials {
    pub credentials: super::S3Credentials,
}
...
pub struct HTTPConfig {
    pub config: super::HTTPConfig,
}

#[derive(Clone, Default, Serialize, Deserialize)]
#[pyclass(module = "daft.daft", from_py_object)]
pub struct UnityConfig {
    pub config: super::UnityConfig,
}

#[derive(Clone, Default, Serialize, Deserialize)]
#[pyclass(module = "daft.daft", from_py_object)]
pub struct GravitinoConfig {
    pub config: super::GravitinoConfig,
}

#[derive(Clone, Default, Serialize, Deserialize)]
#[pyclass(module = "daft.daft", from_py_object)]
pub struct HuggingFaceConfig {
    pub config: super::HuggingFaceConfig,
}

#[derive(Clone, Default, Serialize, Deserialize)]
#[pyclass(module = "daft.daft", from_py_object)]
pub struct TosConfig {
    pub config: super::TosConfig,
}
...
impl S3Config {
    ...
    pub fn new(
        ...
        let def = super::S3Config::default();
        Ok(Self {
...
impl S3CredentialsProvider for PyS3CredentialsProvider {
    ...
    fn provide_credentials(&self) -> DaftResult<super::S3Credentials> {
        Python::attach(|py| {
...
impl AzureConfig {
    ...
    pub fn new(
        ...
        let def = super::AzureConfig::default();
        Self {
...
impl GCSConfig {
    ...
    pub fn new(
        ...
        let def = super::GCSConfig::default();
        Self {
...
impl HTTPConfig {
    ...
    pub fn new(
        ...
        let def = super::HTTPConfig::default();
        Self {
...
impl UnityConfig {
    ...
    pub fn new(endpoint: Option<String>, token: Option<String>) -> Self {
        let default = super::UnityConfig::default();
        Self {
            config: super::UnityConfig {
...
impl GravitinoConfig {
    ...
    pub fn new(
        ...
        let default = super::GravitinoConfig::default();
        Self {
            config: super::GravitinoConfig {
                endpoint: endpoint.or(default.endpoint),
...
impl HuggingFaceConfig {
    ...
    pub fn new(
        ...
        let default = super::HuggingFaceConfig::default();
        Self {
            config: super::HuggingFaceConfig {
                token: token.map(Into::into).or(default.token),
...
impl TosConfig {
    ...
    pub fn new(
        ...
        let def = super::TosConfig::default();
        Ok(Self {
            config: super::TosConfig {
...
impl CosConfig {
    ...
    pub fn new(
        ...
        let def = super::CosConfig::default();
        Ok(Self {
            config: super::CosConfig {
                region: region.or(def.region),
                endpoint: endpoint.or(def.endpoint),
