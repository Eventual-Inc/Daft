...
use crate::{
    ...
    statistics::{TaskEvent, StatisticsManagerRef},
    utils::{
        channel::{
    ...
    fn handle_new_tasks(
        ...
        if let Some(new_task) = maybe_new_task {
            ...
            for task in &enqueueable_tasks {
                ...
                statistics_manager.handle_event(TaskEvent::TaskSubmitted {
            ...
            || dispatcher.has_running_tasks()
        {
            ...
            if !scheduled_tasks.is_empty() {
                ...
                for task in &scheduled_tasks {
                    ...
                    statistics_manager.handle_event(TaskEvent::TaskScheduled {
                        context: task_context,
                    })?;
                }
