...
impl LocalRepartitionNode {
    const NODE_NAME: NodeName = "LocalRepartition";
...
impl TreeDisplay for LocalRepartitionNode {
...
impl DistributedPipelineNode for LocalRepartitionNode {
