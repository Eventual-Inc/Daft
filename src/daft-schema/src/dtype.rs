        ...
        match self {
            ...
            Rect(mode) => match mode.dimension {
                Dimension::XY => Struct(vec![
                    Field::new("xmin", Self::Float64),
                    Field::new("ymin", Self::Float64),
                    Field::new("xmax", Self::Float64),
                    Field::new("ymax", Self::Float64),
                ]),
                Dimension::XYZ => Struct(vec![
                    Field::new("xmin", Self::Float64),
                    Field::new("ymin", Self::Float64),
                    Field::new("zmin", Self::Float64),
                    Field::new("xmax", Self::Float64),
                    Field::new("ymax", Self::Float64),
                    Field::new("zmax", Self::Float64),
                ]),
                Dimension::XYM => Struct(vec![
                    Field::new("xmin", Self::Float64),
                    Field::new("ymin", Self::Float64),
                    Field::new("mmin", Self::Float64),
                    Field::new("xmax", Self::Float64),
                    Field::new("ymax", Self::Float64),
                    Field::new("mmax", Self::Float64),
                ]),
                Dimension::XYZM => Struct(vec![
                    Field::new("xmin", Self::Float64),
                    Field::new("ymin", Self::Float64),
