...
pub mod rel {
        ...
        P: Into<Arc<Expr>>,
    {
        ...
        Ok(Filter { plan_id: None, node_id: None, input, predicate, stats_state: stats::StatsState::NotMaterialized })
    }
    ...
    {
        let input: Arc<LogicalPlan> = input.into();
        Ok(Limit { plan_id: None, node_id: None, input, limit, eager: false, stats_state: stats::StatsState::NotMaterialized })
    }
    ...
    {
        let input: Arc<LogicalPlan> = input.into();
        Ok(Distinct { plan_id: None, node_id: None, input, stats_state: stats::StatsState::NotMaterialized, columns: None })
    }
        ...
        R: Into<Arc<LogicalPlan>>,
    {
        let lhs = lhs.into();
        let rhs = rhs.into();
        Ok(Concat { plan_id: None, node_id: None, input: lhs, other: rhs, stats_state: stats::StatsState::NotMaterialized })
    }
        ...
        R: Into<Arc<LogicalPlan>>,
    {
        let lhs = lhs.into();
        let rhs = rhs.into();
        Ok(Intersect { plan_id: None, node_id: None, lhs, rhs, is_all })
    }
        ...
        R: Into<Arc<LogicalPlan>>,
    {
        ...
        Ok(Union { plan_id: None, node_id: None, lhs, rhs, quantifier, strategy })
    }
