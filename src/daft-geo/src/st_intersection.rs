...
#[typetag::serde]
impl ScalarUDF for StIntersection {
    ...
    fn docstring(&self) -> &'static str {
        "Returns the geometric intersection of two polygon geometries. Non-polygon inputs return null."
    }
}

#[must_use]
pub fn st_intersection(geom_a: ExprRef, geom_b: ExprRef) -> ExprRef {
    ScalarFn::builtin(StIntersection, vec![geom_a, geom_b]).into()
}
