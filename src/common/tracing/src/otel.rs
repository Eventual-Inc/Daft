...
pub fn init_opentelemetry_providers() -> Option<impl Layer<Registry>> {
    ...
    let layer = ioruntime.block_on_current_thread(async {
...
async fn init_otlp_tracer_provider(otlp_endpoint: &str) -> impl Layer<Registry> {
