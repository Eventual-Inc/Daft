use crate::ffi::ArrowArrayRef;
use crate::{bitmap::Bitmap, datatypes::DataType};
use std::any::Any;

use crate::array::MutableArray;
use crate::bitmap::MutableBitmap;
use crate::{array::Array, datatypes::PhysicalType, error::Error};

use super::ffi::{FromFfi, ToFfi};
...
impl<A: ArrowArrayRef> FromFfi<A> for NullArray {
    unsafe fn try_from_ffi(array: A) -> crate::error::Result<Self> {
