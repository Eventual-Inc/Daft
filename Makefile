...
.PHONY: doctests
doctests:
	DAFT_BOLD_TABLE_HEADERS=0 pytest --doctest-modules --continue-on-collection-errors daft/dataframe/dataframe.py daft/expressions/expressions.py daft/convert.py daft/udf/__init__.py daft/udf/legacy.py daft/functions/functions.py daft/datatype.py
